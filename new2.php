...
<head>
    ...
    <link rel="stylesheet" href="apppp.css">
</head>
...
<?php
$an=$_GET['patient_name'];
$bn=$_GET['patient_number'];
$cn=$_GET['gender'];
$dn=$_GET['patient_address'];
$en=$_GET['email'];
$fn=$_GET['pincode'];
$gn=$_GET['problem'];
$hn=$_GET['doctor'];
$in=$_GET['appointment_date'];
...
echo"$hn";
echo"$in";  */
$query="insert into patient values ('$an','$bn','$cn','$dn','$en','$fn','$gn','$hn','$in')";
